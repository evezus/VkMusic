...
public class ListFriendsActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    protected void onCreate(Bundle savedInstanceState) {
        ...
        VKRequest request = new VKRequest("friends.get", VKParameters.from(VKApiConst.FIELDS, "id, first_name, last_name, photo_100, online",
        ...
        request.executeWithListener(new VKRequest.VKRequestListener() {
            ...
            public void onComplete(VKResponse response) {
                ...
                tx.setAdapter( new FriendsListAdapter(ListFriendsActivity.this,(ArrayList) Friend.parseJson(response)) );
            }
        });
    }
    @Override
